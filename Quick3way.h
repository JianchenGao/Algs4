...
class Quick3waySortTest :public ::testing::Test {
...
protected:
	...
	Quick3way<double> quick3way_double;
...
TEST_F(Quick3waySortTest, 5KRandData)
{
	quick3way_double.sort(a_5K);
	ASSERT_EQ(quick3way_double.isSorted(a_5K), true);
}

TEST_F(Quick3waySortTest, 10KRandData)
{
	quick3way_double.sort(a_10K);
	ASSERT_EQ(quick3way_double.isSorted(a_10K), true);
}

TEST_F(Quick3waySortTest, 100KRandData)
{
	quick3way_double.sort(a_100K);
	ASSERT_EQ(quick3way_double.isSorted(a_100K), true);
}
